...
const messages: Record<Locale, Record<string, string>> = {
  'zh-CN': {
    ...
    'silicon.title': 'SiliconFlow 模型扫描',
    'silicon.desc': '通过内置终端执行模型列表和测试脚本。',
    'silicon.apiKey': 'API Key',
    'silicon.fetchList': '获取列表',
    'silicon.startScan': '开始扫描',
    'silicon.stop': '停止',
    'silicon.modelId': '模型 ID',
    'silicon.doubleClickCopy': '双击复制',
    'silicon.status': '状态',
    'silicon.status.success': '成功',
    'silicon.status.failed': '失败',
    'silicon.status.testing': '测试中',
    'silicon.status.idle': '空闲',
    'silicon.responseError': '响应 / 错误',
    'silicon.noActiveTerminal': '没有可用活动终端，请等待终端启动。',
    'silicon.enterApiKey': '请输入 API Key。',
    'silicon.fetchBeforeScan': '请先获取模型列表再扫描。',
    'silicon.scanCompleted': '模型扫描完成。',
    'silicon.copySuccess': '已复制：{id}',
    'silicon.copyFailed': '复制失败，剪贴板权限不足。',
  },
  'en-US': {
    'app.brand': 'ToolHub',
    ...
    'app.menu.siliconflow': 'Model Scanner',
    ...
    'silicon.title': 'SiliconFlow Model Scanner',
    'silicon.desc': 'Run model list and model test scripts through the integrated terminal.',
    'silicon.apiKey': 'API Key',
    'silicon.fetchList': 'Fetch List',
    'silicon.startScan': 'Start Scan',
    'silicon.stop': 'Stop',
    'silicon.modelId': 'Model ID',
    'silicon.doubleClickCopy': 'Double click to copy',
    'silicon.status': 'Status',
    'silicon.status.success': 'Success',
    'silicon.status.failed': 'Failed',
    'silicon.status.testing': 'Testing',
    'silicon.status.idle': 'Idle',
    'silicon.responseError': 'Response / Error',
    'silicon.noActiveTerminal': 'No active terminal available. Wait for terminal startup.',
    'silicon.enterApiKey': 'Please enter an API key.',
    'silicon.fetchBeforeScan': 'Fetch model list before scanning.',
    'silicon.scanCompleted': 'Model scan completed.',
    'silicon.copySuccess': 'Copied: {id}',
    'silicon.copyFailed': 'Copy failed. Clipboard permission denied.',
  },
}
